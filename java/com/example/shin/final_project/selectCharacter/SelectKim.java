...
public class SelectKim extends SurfaceView{
    ...
    public SelectKim(Context context, int resource) {
        super(context);
    ...
    public void getH(){
        ...
        Xpos = cvsWidth- cvsWidth/4 - frameWidth/2 - frameWidth/5;
